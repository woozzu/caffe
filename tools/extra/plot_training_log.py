...
def create_field_index():
    ...
    field_index = {train_key:{'Iters':0, 'Seconds':1, train_key + ' loss':5,
                   ...
                   test_key:{'Iters':0, 'Seconds':1, test_key + ' accuracy':11,
                             test_key + ' loss':9}}
    fields = set()
...
def load_data(data_file, field_idx0, field_idx1):
    ...
    with open(data_file, 'r') as f:
        ...
        for line in csvReader:
            data[0].append(float(line[csvReader.fieldnames[field_idx0]]))
            data[1].append(float(line[csvReader.fieldnames[field_idx1]]))
    return data
